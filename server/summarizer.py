...
def suggest_image_kwords(ticker: str, model: Optional[str] = "gpt-4o-mini-2024-07-18", user_prompt: Optional[str] = None) -> str:
...
def suggest_title(content: str, ticker: str, model: Optional[str] = "gpt-4o-m", user_prompts: Optional[dict] = None) -> str:
    ...
    Args:
        ...
        ticker (str): corresponding ASX company ticker
...
def summarize_content(content: str, model: Optional[str] = "gpt-4o-mini", prompt: Optional[str] = None) -> dict:
    client = openai.Client(api_key=config("OPENAI_KEY"))
